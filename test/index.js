...
readFile('./introduction.js', "utf-8", function(err, value) {
    ...
    var messageRegExp = /Hello\! My name is (.*). I'm (.*) years old, and I am a\(n\) (.*) (.*) major at Union College\./;
    assert.ok(messageRegExp.test(message), "The message doesn't match the correct format. It should look something like: \n\n\
    Hello! My name is Benjamin Barber. I'm 33 years old, and I am a(n) Senior Computer Information Systems major at Union College.\n");
